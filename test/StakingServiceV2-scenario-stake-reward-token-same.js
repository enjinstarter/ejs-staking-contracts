  ...
  describe("Scenario - same stake and reward token", function () {
    it("Should be able to stake, claim reward, revoke, unstake and withdraw", async () => {
      const stakeEvents = [
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685640218),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685646828),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685654064),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685662683),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685665576),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685673101),
          eventType: "Revoke",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685678961),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685687577),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685692929),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685698858),
          eventType: "Revoke",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685706905),
          eventType: "Revoke",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685711144),
          eventType: "Revoke",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685720025),
          eventType: "Revoke",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685728162),
          eventType: "RemoveReward",
          poolIndex: 0,
          signer: contractAdminRoleAccounts[1],
          signerAddress: await contractAdminRoleAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685733456),
          eventType: "RemoveRevokedStakes",
          poolIndex: 0,
          signer: contractAdminRoleAccounts[1],
          signerAddress: await contractAdminRoleAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685737317),
          eventType: "RemovePenalty",
          poolIndex: 0,
          signer: contractAdminRoleAccounts[1],
          signerAddress: await contractAdminRoleAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685746622),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685751878),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685756126),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685762163),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685770122),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685778771),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685788256),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685797281),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685807146),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685812662),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685816370),
          eventType: "Unstake",
          poolIndex: 1,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685823852),
          eventType: "Unstake",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685827000),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685832969),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685835902),
          eventType: "Unstake",
          poolIndex: 2,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685845882),
          eventType: "Unstake",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685847064),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685848247),
          eventType: "Unstake",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685851384),
          eventType: "Unstake",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685863689),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685867167),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685870725),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685879446),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685888157),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685893976),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685899614),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685908629),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685914950),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685923265),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685928106),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685932853),
          eventType: "Unstake",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685942121),
          eventType: "Unstake",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685945245),
          eventType: "Unstake",
          poolIndex: 2,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685954653),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685960750),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685969534),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685975056),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685980195),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685983497),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685989327),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31685999282),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686005920),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686010155),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686013424),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686018171),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686021349),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686027142),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686035712),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686044032),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686053518),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686058057),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686066132),
          eventType: "Claim",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686074321),
          eventType: "Claim",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686080622),
          eventType: "Claim",
          poolIndex: 2,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686089961),
          eventType: "Withdraw",
          poolIndex: 0,
          signer: enduserAccounts[1],
          signerAddress: await enduserAccounts[1].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686099898),
          eventType: "Withdraw",
          poolIndex: 1,
          signer: enduserAccounts[2],
          signerAddress: await enduserAccounts[2].getAddress(),
        ...
        {
          eventSecondsAfterStartblockTimestamp:
            hre.ethers.BigNumber.from(31686104996),
          eventType: "Withdraw",
          poolIndex: 2,
          signer: enduserAccounts[0],
          signerAddress: await enduserAccounts[0].getAddress(),
      ...
      const {
        nextExpectStakeInfos: stakeInfos267,
        nextExpectStakingPoolStats: stakingPoolStats267,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[266],
        stakeEvents[223],
        null,
      ...
      stakeInfos.push(stakeInfos267);
      console.log(
        `\nstakeInfoAfterEvent266 after: ${JSON.stringify(stakeInfos[267].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[223].poolIndex].poolId},${stakeEvents[223].signerAddress},${stakeEvents[223].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats267);
      console.log(
        `stakingPoolStatsAfterEvent266 after: ${JSON.stringify(stakingPoolStats[267].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[223].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos268,
        nextExpectStakingPoolStats: stakingPoolStats268,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[267],
        stakeEvents[214],
        null,
      ...
      stakeInfos.push(stakeInfos268);
      console.log(
        `\nstakeInfoAfterEvent267 after: ${JSON.stringify(stakeInfos[268].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId},${stakeEvents[214].signerAddress},${stakeEvents[214].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats268);
      console.log(
        `stakingPoolStatsAfterEvent267 after: ${JSON.stringify(stakingPoolStats[268].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos269,
        nextExpectStakingPoolStats: stakingPoolStats269,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[268],
        stakeEvents[220],
        null,
      ...
      stakeInfos.push(stakeInfos269);
      console.log(
        `\nstakeInfoAfterEvent268 after: ${JSON.stringify(stakeInfos[269].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId},${stakeEvents[220].signerAddress},${stakeEvents[220].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats269);
      console.log(
        `stakingPoolStatsAfterEvent268 after: ${JSON.stringify(stakingPoolStats[269].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos270,
        nextExpectStakingPoolStats: stakingPoolStats270,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[269],
        stakeEvents[207],
        null,
      ...
      stakeInfos.push(stakeInfos270);
      console.log(
        `\nstakeInfoAfterEvent269 after: ${JSON.stringify(stakeInfos[270].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId},${stakeEvents[207].signerAddress},${stakeEvents[207].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats270);
      console.log(
        `stakingPoolStatsAfterEvent269 after: ${JSON.stringify(stakingPoolStats[270].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos271,
        nextExpectStakingPoolStats: stakingPoolStats271,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[270],
        stakeEvents[214],
        stakeEvents[267],
      ...
      stakeInfos.push(stakeInfos271);
      console.log(
        `\nstakeInfoAfterEvent270 after: ${JSON.stringify(stakeInfos[271].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId},${stakeEvents[214].signerAddress},${stakeEvents[214].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats271);
      console.log(
        `stakingPoolStatsAfterEvent270 after: ${JSON.stringify(stakingPoolStats[271].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos272,
        nextExpectStakingPoolStats: stakingPoolStats272,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[271],
        stakeEvents[223],
        stakeEvents[266],
      ...
      stakeInfos.push(stakeInfos272);
      console.log(
        `\nstakeInfoAfterEvent271 after: ${JSON.stringify(stakeInfos[272].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[223].poolIndex].poolId},${stakeEvents[223].signerAddress},${stakeEvents[223].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats272);
      console.log(
        `stakingPoolStatsAfterEvent271 after: ${JSON.stringify(stakingPoolStats[272].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[223].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos273,
        nextExpectStakingPoolStats: stakingPoolStats273,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[272],
        stakeEvents[220],
        stakeEvents[268],
      ...
      stakeInfos.push(stakeInfos273);
      console.log(
        `\nstakeInfoAfterEvent272 after: ${JSON.stringify(stakeInfos[273].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId},${stakeEvents[220].signerAddress},${stakeEvents[220].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats273);
      console.log(
        `stakingPoolStatsAfterEvent272 after: ${JSON.stringify(stakingPoolStats[273].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos274,
        nextExpectStakingPoolStats: stakingPoolStats274,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[273],
        stakeEvents[207],
        null,
      ...
      stakeInfos.push(stakeInfos274);
      console.log(
        `\nstakeInfoAfterEvent273 after: ${JSON.stringify(stakeInfos[274].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId},${stakeEvents[207].signerAddress},${stakeEvents[207].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats274);
      console.log(
        `stakingPoolStatsAfterEvent273 after: ${JSON.stringify(stakingPoolStats[274].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos275,
        nextExpectStakingPoolStats: stakingPoolStats275,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[274],
        stakeEvents[214],
        stakeEvents[267],
      ...
      stakeInfos.push(stakeInfos275);
      console.log(
        `\nstakeInfoAfterEvent274 after: ${JSON.stringify(stakeInfos[275].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId},${stakeEvents[214].signerAddress},${stakeEvents[214].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats275);
      console.log(
        `stakingPoolStatsAfterEvent274 after: ${JSON.stringify(stakingPoolStats[275].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos276,
        nextExpectStakingPoolStats: stakingPoolStats276,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[275],
        stakeEvents[220],
        stakeEvents[268],
      ...
      stakeInfos.push(stakeInfos276);
      console.log(
        `\nstakeInfoAfterEvent275 after: ${JSON.stringify(stakeInfos[276].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId},${stakeEvents[220].signerAddress},${stakeEvents[220].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats276);
      console.log(
        `stakingPoolStatsAfterEvent275 after: ${JSON.stringify(stakingPoolStats[276].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[220].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos277,
        nextExpectStakingPoolStats: stakingPoolStats277,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[276],
        stakeEvents[207],
        stakeEvents[273],
      ...
      stakeInfos.push(stakeInfos277);
      console.log(
        `\nstakeInfoAfterEvent276 after: ${JSON.stringify(stakeInfos[277].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId},${stakeEvents[207].signerAddress},${stakeEvents[207].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats277);
      console.log(
        `stakingPoolStatsAfterEvent276 after: ${JSON.stringify(stakingPoolStats[277].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[207].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos278,
        nextExpectStakingPoolStats: stakingPoolStats278,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[277],
        stakeEvents[103],
        stakeEvents[199],
      ...
      stakeInfos.push(stakeInfos278);
      console.log(
        `\nstakeInfoAfterEvent277 after: ${JSON.stringify(stakeInfos[278].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[103].poolIndex].poolId},${stakeEvents[103].signerAddress},${stakeEvents[103].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats278);
      console.log(
        `stakingPoolStatsAfterEvent277 after: ${JSON.stringify(stakingPoolStats[278].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[103].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos279,
        nextExpectStakingPoolStats: stakingPoolStats279,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[278],
        stakeEvents[214],
        stakeEvents[267],
      ...
      stakeInfos.push(stakeInfos279);
      console.log(
        `\nstakeInfoAfterEvent278 after: ${JSON.stringify(stakeInfos[279].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId},${stakeEvents[214].signerAddress},${stakeEvents[214].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats279);
      console.log(
        `stakingPoolStatsAfterEvent278 after: ${JSON.stringify(stakingPoolStats[279].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[214].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos280,
        nextExpectStakingPoolStats: stakingPoolStats280,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[279],
        stakeEvents[279],
        null,
      ...
      stakeInfos.push(stakeInfos280);
      stakingPoolStats.push(stakingPoolStats280);
      console.log(
        `stakingPoolStatsAfterEvent279 after: ${JSON.stringify(stakingPoolStats[280].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[279].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos281,
        nextExpectStakingPoolStats: stakingPoolStats281,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[280],
        stakeEvents[280],
        null,
      ...
      stakeInfos.push(stakeInfos281);
      stakingPoolStats.push(stakingPoolStats281);
      console.log(
        `stakingPoolStatsAfterEvent280 after: ${JSON.stringify(stakingPoolStats[281].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[280].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos282,
        nextExpectStakingPoolStats: stakingPoolStats282,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[281],
        stakeEvents[281],
        null,
      ...
      stakeInfos.push(stakeInfos282);
      stakingPoolStats.push(stakingPoolStats282);
      console.log(
        `stakingPoolStatsAfterEvent281 after: ${JSON.stringify(stakingPoolStats[282].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[281].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos283,
        nextExpectStakingPoolStats: stakingPoolStats283,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[282],
        stakeEvents[245],
        null,
      ...
      stakeInfos.push(stakeInfos283);
      console.log(
        `\nstakeInfoAfterEvent282 after: ${JSON.stringify(stakeInfos[283].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId},${stakeEvents[245].signerAddress},${stakeEvents[245].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats283);
      console.log(
        `stakingPoolStatsAfterEvent282 after: ${JSON.stringify(stakingPoolStats[283].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos284,
        nextExpectStakingPoolStats: stakingPoolStats284,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[283],
        stakeEvents[243],
        null,
      ...
      stakeInfos.push(stakeInfos284);
      console.log(
        `\nstakeInfoAfterEvent283 after: ${JSON.stringify(stakeInfos[284].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId},${stakeEvents[243].signerAddress},${stakeEvents[243].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats284);
      console.log(
        `stakingPoolStatsAfterEvent283 after: ${JSON.stringify(stakingPoolStats[284].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos285,
        nextExpectStakingPoolStats: stakingPoolStats285,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[284],
        stakeEvents[240],
        null,
      ...
      stakeInfos.push(stakeInfos285);
      console.log(
        `\nstakeInfoAfterEvent284 after: ${JSON.stringify(stakeInfos[285].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId},${stakeEvents[240].signerAddress},${stakeEvents[240].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats285);
      console.log(
        `stakingPoolStatsAfterEvent284 after: ${JSON.stringify(stakingPoolStats[285].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos286,
        nextExpectStakingPoolStats: stakingPoolStats286,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[285],
        stakeEvents[217],
        null,
      ...
      stakeInfos.push(stakeInfos286);
      console.log(
        `\nstakeInfoAfterEvent285 after: ${JSON.stringify(stakeInfos[286].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId},${stakeEvents[217].signerAddress},${stakeEvents[217].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats286);
      console.log(
        `stakingPoolStatsAfterEvent285 after: ${JSON.stringify(stakingPoolStats[286].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos287,
        nextExpectStakingPoolStats: stakingPoolStats287,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[286],
        stakeEvents[212],
        null,
      ...
      stakeInfos.push(stakeInfos287);
      console.log(
        `\nstakeInfoAfterEvent286 after: ${JSON.stringify(stakeInfos[287].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId},${stakeEvents[212].signerAddress},${stakeEvents[212].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats287);
      console.log(
        `stakingPoolStatsAfterEvent286 after: ${JSON.stringify(stakingPoolStats[287].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos288,
        nextExpectStakingPoolStats: stakingPoolStats288,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[287],
        stakeEvents[231],
        null,
      ...
      stakeInfos.push(stakeInfos288);
      console.log(
        `\nstakeInfoAfterEvent287 after: ${JSON.stringify(stakeInfos[288].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId},${stakeEvents[231].signerAddress},${stakeEvents[231].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats288);
      console.log(
        `stakingPoolStatsAfterEvent287 after: ${JSON.stringify(stakingPoolStats[288].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos289,
        nextExpectStakingPoolStats: stakingPoolStats289,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[288],
        stakeEvents[211],
        null,
      ...
      stakeInfos.push(stakeInfos289);
      console.log(
        `\nstakeInfoAfterEvent288 after: ${JSON.stringify(stakeInfos[289].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId},${stakeEvents[211].signerAddress},${stakeEvents[211].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats289);
      console.log(
        `stakingPoolStatsAfterEvent288 after: ${JSON.stringify(stakingPoolStats[289].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos290,
        nextExpectStakingPoolStats: stakingPoolStats290,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[289],
        stakeEvents[201],
        null,
      ...
      stakeInfos.push(stakeInfos290);
      console.log(
        `\nstakeInfoAfterEvent289 after: ${JSON.stringify(stakeInfos[290].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId},${stakeEvents[201].signerAddress},${stakeEvents[201].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats290);
      console.log(
        `stakingPoolStatsAfterEvent289 after: ${JSON.stringify(stakingPoolStats[290].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos291,
        nextExpectStakingPoolStats: stakingPoolStats291,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[290],
        stakeEvents[200],
        null,
      ...
      stakeInfos.push(stakeInfos291);
      console.log(
        `\nstakeInfoAfterEvent290 after: ${JSON.stringify(stakeInfos[291].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId},${stakeEvents[200].signerAddress},${stakeEvents[200].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats291);
      console.log(
        `stakingPoolStatsAfterEvent290 after: ${JSON.stringify(stakingPoolStats[291].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos292,
        nextExpectStakingPoolStats: stakingPoolStats292,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[291],
        stakeEvents[12],
        null,
      ...
      stakeInfos.push(stakeInfos292);
      console.log(
        `\nstakeInfoAfterEvent291 after: ${JSON.stringify(stakeInfos[292].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId},${stakeEvents[12].signerAddress},${stakeEvents[12].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats292);
      console.log(
        `stakingPoolStatsAfterEvent291 after: ${JSON.stringify(stakingPoolStats[292].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos293,
        nextExpectStakingPoolStats: stakingPoolStats293,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[292],
        stakeEvents[243],
        null,
      ...
      stakeInfos.push(stakeInfos293);
      console.log(
        `\nstakeInfoAfterEvent292 after: ${JSON.stringify(stakeInfos[293].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId},${stakeEvents[243].signerAddress},${stakeEvents[243].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats293);
      console.log(
        `stakingPoolStatsAfterEvent292 after: ${JSON.stringify(stakingPoolStats[293].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos294,
        nextExpectStakingPoolStats: stakingPoolStats294,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[293],
        stakeEvents[245],
        null,
      ...
      stakeInfos.push(stakeInfos294);
      console.log(
        `\nstakeInfoAfterEvent293 after: ${JSON.stringify(stakeInfos[294].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId},${stakeEvents[245].signerAddress},${stakeEvents[245].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats294);
      console.log(
        `stakingPoolStatsAfterEvent293 after: ${JSON.stringify(stakingPoolStats[294].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos295,
        nextExpectStakingPoolStats: stakingPoolStats295,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[294],
        stakeEvents[240],
        null,
      ...
      stakeInfos.push(stakeInfos295);
      console.log(
        `\nstakeInfoAfterEvent294 after: ${JSON.stringify(stakeInfos[295].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId},${stakeEvents[240].signerAddress},${stakeEvents[240].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats295);
      console.log(
        `stakingPoolStatsAfterEvent294 after: ${JSON.stringify(stakingPoolStats[295].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos296,
        nextExpectStakingPoolStats: stakingPoolStats296,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[295],
        stakeEvents[231],
        null,
      ...
      stakeInfos.push(stakeInfos296);
      console.log(
        `\nstakeInfoAfterEvent295 after: ${JSON.stringify(stakeInfos[296].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId},${stakeEvents[231].signerAddress},${stakeEvents[231].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats296);
      console.log(
        `stakingPoolStatsAfterEvent295 after: ${JSON.stringify(stakingPoolStats[296].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos297,
        nextExpectStakingPoolStats: stakingPoolStats297,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[296],
        stakeEvents[212],
        null,
      ...
      stakeInfos.push(stakeInfos297);
      console.log(
        `\nstakeInfoAfterEvent296 after: ${JSON.stringify(stakeInfos[297].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId},${stakeEvents[212].signerAddress},${stakeEvents[212].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats297);
      console.log(
        `stakingPoolStatsAfterEvent296 after: ${JSON.stringify(stakingPoolStats[297].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos298,
        nextExpectStakingPoolStats: stakingPoolStats298,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[297],
        stakeEvents[217],
        null,
      ...
      stakeInfos.push(stakeInfos298);
      console.log(
        `\nstakeInfoAfterEvent297 after: ${JSON.stringify(stakeInfos[298].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId},${stakeEvents[217].signerAddress},${stakeEvents[217].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats298);
      console.log(
        `stakingPoolStatsAfterEvent297 after: ${JSON.stringify(stakingPoolStats[298].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos299,
        nextExpectStakingPoolStats: stakingPoolStats299,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[298],
        stakeEvents[211],
        null,
      ...
      stakeInfos.push(stakeInfos299);
      console.log(
        `\nstakeInfoAfterEvent298 after: ${JSON.stringify(stakeInfos[299].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId},${stakeEvents[211].signerAddress},${stakeEvents[211].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats299);
      console.log(
        `stakingPoolStatsAfterEvent298 after: ${JSON.stringify(stakingPoolStats[299].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos300,
        nextExpectStakingPoolStats: stakingPoolStats300,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[299],
        stakeEvents[201],
        null,
      ...
      stakeInfos.push(stakeInfos300);
      console.log(
        `\nstakeInfoAfterEvent299 after: ${JSON.stringify(stakeInfos[300].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId},${stakeEvents[201].signerAddress},${stakeEvents[201].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats300);
      console.log(
        `stakingPoolStatsAfterEvent299 after: ${JSON.stringify(stakingPoolStats[300].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos301,
        nextExpectStakingPoolStats: stakingPoolStats301,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[300],
        stakeEvents[200],
        null,
      ...
      stakeInfos.push(stakeInfos301);
      console.log(
        `\nstakeInfoAfterEvent300 after: ${JSON.stringify(stakeInfos[301].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId},${stakeEvents[200].signerAddress},${stakeEvents[200].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats301);
      console.log(
        `stakingPoolStatsAfterEvent300 after: ${JSON.stringify(stakingPoolStats[301].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos302,
        nextExpectStakingPoolStats: stakingPoolStats302,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[301],
        stakeEvents[12],
        null,
      ...
      stakeInfos.push(stakeInfos302);
      console.log(
        `\nstakeInfoAfterEvent301 after: ${JSON.stringify(stakeInfos[302].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId},${stakeEvents[12].signerAddress},${stakeEvents[12].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats302);
      console.log(
        `stakingPoolStatsAfterEvent301 after: ${JSON.stringify(stakingPoolStats[302].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos303,
        nextExpectStakingPoolStats: stakingPoolStats303,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[302],
        stakeEvents[240],
        stakeEvents[294],
      ...
      stakeInfos.push(stakeInfos303);
      console.log(
        `\nstakeInfoAfterEvent302 after: ${JSON.stringify(stakeInfos[303].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId},${stakeEvents[240].signerAddress},${stakeEvents[240].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats303);
      console.log(
        `stakingPoolStatsAfterEvent302 after: ${JSON.stringify(stakingPoolStats[303].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[240].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos304,
        nextExpectStakingPoolStats: stakingPoolStats304,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[303],
        stakeEvents[243],
        stakeEvents[292],
      ...
      stakeInfos.push(stakeInfos304);
      console.log(
        `\nstakeInfoAfterEvent303 after: ${JSON.stringify(stakeInfos[304].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId},${stakeEvents[243].signerAddress},${stakeEvents[243].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats304);
      console.log(
        `stakingPoolStatsAfterEvent303 after: ${JSON.stringify(stakingPoolStats[304].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[243].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos305,
        nextExpectStakingPoolStats: stakingPoolStats305,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[304],
        stakeEvents[245],
        stakeEvents[293],
      ...
      stakeInfos.push(stakeInfos305);
      console.log(
        `\nstakeInfoAfterEvent304 after: ${JSON.stringify(stakeInfos[305].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId},${stakeEvents[245].signerAddress},${stakeEvents[245].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats305);
      console.log(
        `stakingPoolStatsAfterEvent304 after: ${JSON.stringify(stakingPoolStats[305].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[245].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos306,
        nextExpectStakingPoolStats: stakingPoolStats306,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[305],
        stakeEvents[231],
        stakeEvents[295],
      ...
      stakeInfos.push(stakeInfos306);
      console.log(
        `\nstakeInfoAfterEvent305 after: ${JSON.stringify(stakeInfos[306].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId},${stakeEvents[231].signerAddress},${stakeEvents[231].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats306);
      console.log(
        `stakingPoolStatsAfterEvent305 after: ${JSON.stringify(stakingPoolStats[306].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[231].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos307,
        nextExpectStakingPoolStats: stakingPoolStats307,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[306],
        stakeEvents[212],
        stakeEvents[296],
      ...
      stakeInfos.push(stakeInfos307);
      console.log(
        `\nstakeInfoAfterEvent306 after: ${JSON.stringify(stakeInfos[307].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId},${stakeEvents[212].signerAddress},${stakeEvents[212].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats307);
      console.log(
        `stakingPoolStatsAfterEvent306 after: ${JSON.stringify(stakingPoolStats[307].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[212].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos308,
        nextExpectStakingPoolStats: stakingPoolStats308,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[307],
        stakeEvents[217],
        stakeEvents[297],
      ...
      stakeInfos.push(stakeInfos308);
      console.log(
        `\nstakeInfoAfterEvent307 after: ${JSON.stringify(stakeInfos[308].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId},${stakeEvents[217].signerAddress},${stakeEvents[217].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats308);
      console.log(
        `stakingPoolStatsAfterEvent307 after: ${JSON.stringify(stakingPoolStats[308].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[217].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos309,
        nextExpectStakingPoolStats: stakingPoolStats309,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[308],
        stakeEvents[211],
        stakeEvents[298],
      ...
      stakeInfos.push(stakeInfos309);
      console.log(
        `\nstakeInfoAfterEvent308 after: ${JSON.stringify(stakeInfos[309].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId},${stakeEvents[211].signerAddress},${stakeEvents[211].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats309);
      console.log(
        `stakingPoolStatsAfterEvent308 after: ${JSON.stringify(stakingPoolStats[309].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[211].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos310,
        nextExpectStakingPoolStats: stakingPoolStats310,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[309],
        stakeEvents[201],
        stakeEvents[299],
      ...
      stakeInfos.push(stakeInfos310);
      console.log(
        `\nstakeInfoAfterEvent309 after: ${JSON.stringify(stakeInfos[310].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId},${stakeEvents[201].signerAddress},${stakeEvents[201].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats310);
      console.log(
        `stakingPoolStatsAfterEvent309 after: ${JSON.stringify(stakingPoolStats[310].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[201].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos311,
        nextExpectStakingPoolStats: stakingPoolStats311,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[310],
        stakeEvents[200],
        stakeEvents[300],
      ...
      stakeInfos.push(stakeInfos311);
      console.log(
        `\nstakeInfoAfterEvent310 after: ${JSON.stringify(stakeInfos[311].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId},${stakeEvents[200].signerAddress},${stakeEvents[200].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats311);
      console.log(
        `stakingPoolStatsAfterEvent310 after: ${JSON.stringify(stakingPoolStats[311].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[200].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos312,
        nextExpectStakingPoolStats: stakingPoolStats312,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[311],
        stakeEvents[12],
        stakeEvents[301],
      ...
      stakeInfos.push(stakeInfos312);
      console.log(
        `\nstakeInfoAfterEvent311 after: ${JSON.stringify(stakeInfos[312].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId},${stakeEvents[12].signerAddress},${stakeEvents[12].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats312);
      console.log(
        `stakingPoolStatsAfterEvent311 after: ${JSON.stringify(stakingPoolStats[312].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[12].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos313,
        nextExpectStakingPoolStats: stakingPoolStats313,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[312],
        stakeEvents[124],
        null,
      ...
      stakeInfos.push(stakeInfos313);
      console.log(
        `\nstakeInfoAfterEvent312 after: ${JSON.stringify(stakeInfos[313].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[124].poolIndex].poolId},${stakeEvents[124].signerAddress},${stakeEvents[124].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats313);
      console.log(
        `stakingPoolStatsAfterEvent312 after: ${JSON.stringify(stakingPoolStats[313].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[124].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos314,
        nextExpectStakingPoolStats: stakingPoolStats314,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[313],
        stakeEvents[75],
        null,
      ...
      stakeInfos.push(stakeInfos314);
      console.log(
        `\nstakeInfoAfterEvent313 after: ${JSON.stringify(stakeInfos[314].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[75].poolIndex].poolId},${stakeEvents[75].signerAddress},${stakeEvents[75].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats314);
      console.log(
        `stakingPoolStatsAfterEvent313 after: ${JSON.stringify(stakingPoolStats[314].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[75].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos315,
        nextExpectStakingPoolStats: stakingPoolStats315,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[314],
        stakeEvents[78],
        null,
      ...
      stakeInfos.push(stakeInfos315);
      console.log(
        `\nstakeInfoAfterEvent314 after: ${JSON.stringify(stakeInfos[315].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[78].poolIndex].poolId},${stakeEvents[78].signerAddress},${stakeEvents[78].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats315);
      console.log(
        `stakingPoolStatsAfterEvent314 after: ${JSON.stringify(stakingPoolStats[315].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[78].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos316,
        nextExpectStakingPoolStats: stakingPoolStats316,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[315],
        stakeEvents[124],
        stakeEvents[312],
      ...
      stakeInfos.push(stakeInfos316);
      console.log(
        `\nstakeInfoAfterEvent315 after: ${JSON.stringify(stakeInfos[316].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[124].poolIndex].poolId},${stakeEvents[124].signerAddress},${stakeEvents[124].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats316);
      console.log(
        `stakingPoolStatsAfterEvent315 after: ${JSON.stringify(stakingPoolStats[316].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[124].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos317,
        nextExpectStakingPoolStats: stakingPoolStats317,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[316],
        stakeEvents[75],
        stakeEvents[313],
      ...
      stakeInfos.push(stakeInfos317);
      console.log(
        `\nstakeInfoAfterEvent316 after: ${JSON.stringify(stakeInfos[317].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[75].poolIndex].poolId},${stakeEvents[75].signerAddress},${stakeEvents[75].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats317);
      console.log(
        `stakingPoolStatsAfterEvent316 after: ${JSON.stringify(stakingPoolStats[317].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[75].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos318,
        nextExpectStakingPoolStats: stakingPoolStats318,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[317],
        stakeEvents[78],
        stakeEvents[314],
      ...
      stakeInfos.push(stakeInfos318);
      console.log(
        `\nstakeInfoAfterEvent317 after: ${JSON.stringify(stakeInfos[318].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[78].poolIndex].poolId},${stakeEvents[78].signerAddress},${stakeEvents[78].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats318);
      console.log(
        `stakingPoolStatsAfterEvent317 after: ${JSON.stringify(stakingPoolStats[318].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[78].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos319,
        nextExpectStakingPoolStats: stakingPoolStats319,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[318],
        stakeEvents[57],
        stakeEvents[183],
      ...
      stakeInfos.push(stakeInfos319);
      console.log(
        `\nstakeInfoAfterEvent318 after: ${JSON.stringify(stakeInfos[319].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[57].poolIndex].poolId},${stakeEvents[57].signerAddress},${stakeEvents[57].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats319);
      console.log(
        `stakingPoolStatsAfterEvent318 after: ${JSON.stringify(stakingPoolStats[319].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[57].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos320,
        nextExpectStakingPoolStats: stakingPoolStats320,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[319],
        stakeEvents[68],
        stakeEvents[110],
      ...
      stakeInfos.push(stakeInfos320);
      console.log(
        `\nstakeInfoAfterEvent319 after: ${JSON.stringify(stakeInfos[320].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[68].poolIndex].poolId},${stakeEvents[68].signerAddress},${stakeEvents[68].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats320);
      console.log(
        `stakingPoolStatsAfterEvent319 after: ${JSON.stringify(stakingPoolStats[320].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[68].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos321,
        nextExpectStakingPoolStats: stakingPoolStats321,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[320],
        stakeEvents[74],
        stakeEvents[112],
      ...
      stakeInfos.push(stakeInfos321);
      console.log(
        `\nstakeInfoAfterEvent320 after: ${JSON.stringify(stakeInfos[321].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[74].poolIndex].poolId},${stakeEvents[74].signerAddress},${stakeEvents[74].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats321);
      console.log(
        `stakingPoolStatsAfterEvent320 after: ${JSON.stringify(stakingPoolStats[321].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[74].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos322,
        nextExpectStakingPoolStats: stakingPoolStats322,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[321],
        stakeEvents[79],
        stakeEvents[181],
      ...
      stakeInfos.push(stakeInfos322);
      console.log(
        `\nstakeInfoAfterEvent321 after: ${JSON.stringify(stakeInfos[322].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[79].poolIndex].poolId},${stakeEvents[79].signerAddress},${stakeEvents[79].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats322);
      console.log(
        `stakingPoolStatsAfterEvent321 after: ${JSON.stringify(stakingPoolStats[322].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[79].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos323,
        nextExpectStakingPoolStats: stakingPoolStats323,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[322],
        stakeEvents[172],
        stakeEvents[213],
      ...
      stakeInfos.push(stakeInfos323);
      console.log(
        `\nstakeInfoAfterEvent322 after: ${JSON.stringify(stakeInfos[323].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[172].poolIndex].poolId},${stakeEvents[172].signerAddress},${stakeEvents[172].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats323);
      console.log(
        `stakingPoolStatsAfterEvent322 after: ${JSON.stringify(stakingPoolStats[323].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[172].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos324,
        nextExpectStakingPoolStats: stakingPoolStats324,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[323],
        stakeEvents[176],
        stakeEvents[180],
      ...
      stakeInfos.push(stakeInfos324);
      console.log(
        `\nstakeInfoAfterEvent323 after: ${JSON.stringify(stakeInfos[324].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[176].poolIndex].poolId},${stakeEvents[176].signerAddress},${stakeEvents[176].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats324);
      console.log(
        `stakingPoolStatsAfterEvent323 after: ${JSON.stringify(stakingPoolStats[324].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[176].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos325,
        nextExpectStakingPoolStats: stakingPoolStats325,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[324],
        stakeEvents[79],
        stakeEvents[181],
      ...
      stakeInfos.push(stakeInfos325);
      console.log(
        `\nstakeInfoAfterEvent324 after: ${JSON.stringify(stakeInfos[325].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[79].poolIndex].poolId},${stakeEvents[79].signerAddress},${stakeEvents[79].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats325);
      console.log(
        `stakingPoolStatsAfterEvent324 after: ${JSON.stringify(stakingPoolStats[325].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[79].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos326,
        nextExpectStakingPoolStats: stakingPoolStats326,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[325],
        stakeEvents[172],
        stakeEvents[213],
      ...
      stakeInfos.push(stakeInfos326);
      console.log(
        `\nstakeInfoAfterEvent325 after: ${JSON.stringify(stakeInfos[326].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[172].poolIndex].poolId},${stakeEvents[172].signerAddress},${stakeEvents[172].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats326);
      console.log(
        `stakingPoolStatsAfterEvent325 after: ${JSON.stringify(stakingPoolStats[326].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[172].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos327,
        nextExpectStakingPoolStats: stakingPoolStats327,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[326],
        stakeEvents[176],
        stakeEvents[180],
      ...
      stakeInfos.push(stakeInfos327);
      console.log(
        `\nstakeInfoAfterEvent326 after: ${JSON.stringify(stakeInfos[327].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[176].poolIndex].poolId},${stakeEvents[176].signerAddress},${stakeEvents[176].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats327);
      console.log(
        `stakingPoolStatsAfterEvent326 after: ${JSON.stringify(stakingPoolStats[327].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[176].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos328,
        nextExpectStakingPoolStats: stakingPoolStats328,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[327],
        stakeEvents[131],
        stakeEvents[194],
      ...
      stakeInfos.push(stakeInfos328);
      console.log(
        `\nstakeInfoAfterEvent327 after: ${JSON.stringify(stakeInfos[328].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[131].poolIndex].poolId},${stakeEvents[131].signerAddress},${stakeEvents[131].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats328);
      console.log(
        `stakingPoolStatsAfterEvent327 after: ${JSON.stringify(stakingPoolStats[328].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[131].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos329,
        nextExpectStakingPoolStats: stakingPoolStats329,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[328],
        stakeEvents[118],
        stakeEvents[154],
      ...
      stakeInfos.push(stakeInfos329);
      console.log(
        `\nstakeInfoAfterEvent328 after: ${JSON.stringify(stakeInfos[329].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[118].poolIndex].poolId},${stakeEvents[118].signerAddress},${stakeEvents[118].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats329);
      console.log(
        `stakingPoolStatsAfterEvent328 after: ${JSON.stringify(stakingPoolStats[329].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[118].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos330,
        nextExpectStakingPoolStats: stakingPoolStats330,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[329],
        stakeEvents[58],
        stakeEvents[82],
      ...
      stakeInfos.push(stakeInfos330);
      console.log(
        `\nstakeInfoAfterEvent329 after: ${JSON.stringify(stakeInfos[330].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[58].poolIndex].poolId},${stakeEvents[58].signerAddress},${stakeEvents[58].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats330);
      console.log(
        `stakingPoolStatsAfterEvent329 after: ${JSON.stringify(stakingPoolStats[330].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[58].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos331,
        nextExpectStakingPoolStats: stakingPoolStats331,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[330],
        stakeEvents[133],
        stakeEvents[195],
      ...
      stakeInfos.push(stakeInfos331);
      console.log(
        `\nstakeInfoAfterEvent330 after: ${JSON.stringify(stakeInfos[331].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[133].poolIndex].poolId},${stakeEvents[133].signerAddress},${stakeEvents[133].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats331);
      console.log(
        `stakingPoolStatsAfterEvent330 after: ${JSON.stringify(stakingPoolStats[331].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[133].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos332,
        nextExpectStakingPoolStats: stakingPoolStats332,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[331],
        stakeEvents[130],
        stakeEvents[156],
      ...
      stakeInfos.push(stakeInfos332);
      console.log(
        `\nstakeInfoAfterEvent331 after: ${JSON.stringify(stakeInfos[332].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[130].poolIndex].poolId},${stakeEvents[130].signerAddress},${stakeEvents[130].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats332);
      console.log(
        `stakingPoolStatsAfterEvent331 after: ${JSON.stringify(stakingPoolStats[332].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[130].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos333,
        nextExpectStakingPoolStats: stakingPoolStats333,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[332],
        stakeEvents[134],
        stakeEvents[167],
      ...
      stakeInfos.push(stakeInfos333);
      console.log(
        `\nstakeInfoAfterEvent332 after: ${JSON.stringify(stakeInfos[333].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[134].poolIndex].poolId},${stakeEvents[134].signerAddress},${stakeEvents[134].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats333);
      console.log(
        `stakingPoolStatsAfterEvent332 after: ${JSON.stringify(stakingPoolStats[333].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[134].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos334,
        nextExpectStakingPoolStats: stakingPoolStats334,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[333],
        stakeEvents[202],
        stakeEvents[219],
      ...
      stakeInfos.push(stakeInfos334);
      console.log(
        `\nstakeInfoAfterEvent333 after: ${JSON.stringify(stakeInfos[334].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[202].poolIndex].poolId},${stakeEvents[202].signerAddress},${stakeEvents[202].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats334);
      console.log(
        `stakingPoolStatsAfterEvent333 after: ${JSON.stringify(stakingPoolStats[334].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[202].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos335,
        nextExpectStakingPoolStats: stakingPoolStats335,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[334],
        stakeEvents[198],
        stakeEvents[221],
      ...
      stakeInfos.push(stakeInfos335);
      console.log(
        `\nstakeInfoAfterEvent334 after: ${JSON.stringify(stakeInfos[335].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[198].poolIndex].poolId},${stakeEvents[198].signerAddress},${stakeEvents[198].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats335);
      console.log(
        `stakingPoolStatsAfterEvent334 after: ${JSON.stringify(stakingPoolStats[335].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[198].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos336,
        nextExpectStakingPoolStats: stakingPoolStats336,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[335],
        stakeEvents[208],
        stakeEvents[218],
      ...
      stakeInfos.push(stakeInfos336);
      console.log(
        `\nstakeInfoAfterEvent335 after: ${JSON.stringify(stakeInfos[336].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[208].poolIndex].poolId},${stakeEvents[208].signerAddress},${stakeEvents[208].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats336);
      console.log(
        `stakingPoolStatsAfterEvent335 after: ${JSON.stringify(stakingPoolStats[336].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[208].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos337,
        nextExpectStakingPoolStats: stakingPoolStats337,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[336],
        stakeEvents[202],
        stakeEvents[219],
      ...
      stakeInfos.push(stakeInfos337);
      console.log(
        `\nstakeInfoAfterEvent336 after: ${JSON.stringify(stakeInfos[337].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[202].poolIndex].poolId},${stakeEvents[202].signerAddress},${stakeEvents[202].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats337);
      console.log(
        `stakingPoolStatsAfterEvent336 after: ${JSON.stringify(stakingPoolStats[337].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[202].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos338,
        nextExpectStakingPoolStats: stakingPoolStats338,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[337],
        stakeEvents[198],
        stakeEvents[221],
      ...
      stakeInfos.push(stakeInfos338);
      console.log(
        `\nstakeInfoAfterEvent337 after: ${JSON.stringify(stakeInfos[338].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[198].poolIndex].poolId},${stakeEvents[198].signerAddress},${stakeEvents[198].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats338);
      console.log(
        `stakingPoolStatsAfterEvent337 after: ${JSON.stringify(stakingPoolStats[338].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[198].poolIndex].poolId}`))}`,
      );

      const {
        nextExpectStakeInfos: stakeInfos339,
        nextExpectStakingPoolStats: stakingPoolStats339,
      } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
        stakeEvents[338],
        stakeEvents[208],
        stakeEvents[218],
      ...
      stakeInfos.push(stakeInfos339);
      console.log(
        `\nstakeInfoAfterEvent338 after: ${JSON.stringify(stakeInfos[339].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[208].poolIndex].poolId},${stakeEvents[208].signerAddress},${stakeEvents[208].stakeId}`))}`,
      );
      stakingPoolStats.push(stakingPoolStats339);
      console.log(
        `stakingPoolStatsAfterEvent338 after: ${JSON.stringify(stakingPoolStats[339].get(`${stakingPoolStakeRewardTokenSameConfigs[stakeEvents[208].poolIndex].poolId}`))}`,
      );
