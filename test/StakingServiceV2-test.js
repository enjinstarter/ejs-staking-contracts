...
describe("StakingServiceV2", function () {
  ...
  it.only("Should be able to stake, claim reward, revoke, unstake and withdraw", async () => {
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats001,
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats002,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[1],
      stakeEvents[1],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos001,
      _stakingPoolStats001,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats003,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[2],
      stakeEvents[2],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos002,
      _stakingPoolStats002,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats004,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[3],
      stakeEvents[3],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos003,
      _stakingPoolStats003,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats005,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[4],
      stakeEvents[4],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos004,
      _stakingPoolStats004,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats007,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[6],
      stakeEvents[2],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos006,
      _stakingPoolStats006,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats008,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[7],
      stakeEvents[7],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos007,
      _stakingPoolStats007,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats009,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[8],
      stakeEvents[8],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos008,
      _stakingPoolStats008,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats010,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[9],
      stakeEvents[9],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos009,
      _stakingPoolStats009,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats011,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[10],
      stakeEvents[10],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos010,
      _stakingPoolStats010,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats012,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[11],
      stakeEvents[1],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos011,
      _stakingPoolStats011,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats013,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[12],
      stakeEvents[12],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos012,
      _stakingPoolStats012,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats015,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[14],
      stakeEvents[14],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos014,
      _stakingPoolStats014,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats016,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[15],
      stakeEvents[1],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos015,
      _stakingPoolStats015,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats017,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[16],
      stakeEvents[4],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos016,
      _stakingPoolStats016,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats018,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[17],
      stakeEvents[17],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos017,
      _stakingPoolStats017,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats019,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[18],
      stakeEvents[12],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos018,
      _stakingPoolStats018,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats020,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[19],
      stakeEvents[14],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos019,
      _stakingPoolStats019,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats021,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[20],
      stakeEvents[14],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos020,
      _stakingPoolStats020,
    );
    ...
    const {
      ...
      nextExpectStakingPoolStats: _stakingPoolStats022,
    } = stakeServiceHelpers.getNextExpectStakeInfoStakingPoolStats(
      stakeEvents[21],
      stakeEvents[21],
      stakingPoolStakeRewardTokenSameConfigs,
      stakeInfos021,
      _stakingPoolStats021,
    );
